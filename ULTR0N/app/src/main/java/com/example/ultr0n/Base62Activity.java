...
public class Base62Activity extends AppCompatActivity {
    TextView text62;
    EditText base_id_62;
    Button show62;
    EditText flag62;

public void show62(View view)

{
    Base62 bs = Base62.createInstance();
    String s = new String(bs.decode(base_id_62.getText().toString().getBytes()));
    flag62.setText(s);
}
    /**
        ...
        public byte[] decode(final byte[] encoded) {
            if (!isBase62Encoding(encoded)) {
               // throw new IllegalArgumentException("Input is not encoded correctly");
                return "not base62 string".getBytes();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_base62);
        text62 = findViewById(R.id.text62);
        flag62 = findViewById(R.id.flag62);
        base_id_62 = findViewById(R.id.base_id_62);
        show62 = findViewById(R.id.show62);
